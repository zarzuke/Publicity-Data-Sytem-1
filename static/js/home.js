...
function handleUserOptionChange() {
    ...
    const existingUserSelect = document.getElementById('existing-users');
    const newUserFields = document.getElementById('existing-user-selection');

    if (userType === 'existing') {
        // Mostrar el selector de usuarios existentes
        newUserFields.style.display = 'block';

        // Desbloquear campos de nombre, apellido y teléfono
        const nameInput = document.getElementById('name');
        const surnameInput = document.getElementById('surname');
        const phoneInput = document.getElementById('phone');
        ...
        // Ocultar el selector de usuarios existentes
        newUserFields.style.display = 'none';

        // Habilitar campos de nombre, apellido y teléfono
        const nameInput = document.getElementById('name');
        const surnameInput = document.getElementById('surname');
        const phoneInput = document.getElementById('phone');
